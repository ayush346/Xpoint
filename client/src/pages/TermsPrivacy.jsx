...
export default function TermsPrivacy() {
	...
	return (
		<>
			...
			<section className="container-padded py-6 md:py-16 grid gap-6 max-w-3xl mx-auto">
				{sections.map((s, i) => (
					<Section key={s.heading} index={i} heading={s.heading} body={s.body} renderLegal renderLegalHeadings justify immediate={i === 0} />
				))}
			</section>
		</>
	);
