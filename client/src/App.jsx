...
export default function App() {
	...
	function downloadInstaller() {
		...
		link.href = "https://xpoint-uploads-prod.s3.ap-south-1.amazonaws.com/XpointDesktopApp/XPOINT+Setup+1.0.10.exe";
		link.setAttribute("download", "XPOINT Setup 1.0.10.exe");
