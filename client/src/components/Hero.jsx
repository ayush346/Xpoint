		...
		<section className="relative overflow-hidden gradient-hero border-b border-slate-200">
			...
			<div className="container-padded py-20 md:py-28">
				...
				>
					...
					<a href="https://xpoint-uploads-prod.s3.ap-south-1.amazonaws.com/XpointDesktopApp/XPOINT+Setup+1.0.12.exe" download className="btn-solid-yellow w-full sm:w-auto text-center">Download for Desktop</a>
				</motion.div>
			</div>
		</section>
	);
